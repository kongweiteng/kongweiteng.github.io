...
layout:     post
title:      "Hello 2018"
subtitle:   " \"Hello World,Hello Blog,This a demo.\""
...
kwt 的 Blog 就这么开通了。
本文很多内容是原作者的内容，只是为了集成一个demo供以后使用。
借鉴博客地址：http://huangxuan.me

[跳过废话，直接看技术实现 ](#build) 


2018 年， 总算有个地方可以好好写点东西了。这个地方略显高达，不算俗套，赶紧开始吧！
